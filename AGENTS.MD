...
shipped. The `angular/` directory contains legacy source code that is no longer built or
deployed. See [`CHANGELOG.md`](./CHANGELOG.md) for what's landed and [`ROADMAP.md`](./ROADMAP.md)
for what's next.
